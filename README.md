...
* [ADDED] cmd listsearch : shows all results as a list instead of 1 by 1
* [ADDED] cmd auto : add/remove a link or entire playlist to/from bot's autoplaylist
* [edit] cmd np : can be sent as a pm
* [edit] cmd queue : shows time duration of queued songs and entire queue duration
...
* [ping z03h#6374](https://discord.gg/ZAKPCCq)
